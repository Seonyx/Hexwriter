...
namespace HexWriter.Web.Controllers
{
    ...
    public class FileUploadController : Controller
    {
        ...
        public ActionResult StartImport(int projectId)
        {
            ...
            System.Web.Hosting.HostingEnvironment.QueueBackgroundWorkItem(ct =>
            {
                try
                {
                    ...
                    using (var importDb = new HexWriterContext())
                    {
                    ...
                    using (var logDb = new HexWriterContext())
                    {
        ...
        private static void WriteImportLogToDb(HexWriterContext logDb, int projectId, bool success,
