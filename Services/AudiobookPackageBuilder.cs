...
namespace HexWriter.Web.Services
{
    public class AudiobookPackageBuilder
    {
        ...
        /// </summary>
        public byte[] BuildPackage(HexWriterContext db, int bookProjectId, VoiceInfo voice, int draftNumber)
        {
            if (voice == null)
        ...
        private string BuildChapterText(HexWriterContext db, Chapter ch, int draftNumber)
        {
