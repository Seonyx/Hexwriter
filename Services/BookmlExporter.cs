...
namespace HexWriter.Web.Services
{
    ...
    public class BookmlExporter
    {
        ...
        public BookmlExportResult ExportChapter(HexWriterContext db, int chapterId, Stream outputStream)
        {
        ...
        public BookmlExportResult Export(HexWriterContext db, int projectId, Stream outputStream)
        {
            var result = new BookmlExportResult();
        ...
        private XDocument BuildNamesXml(HexWriterContext db, int projectId)
        {
